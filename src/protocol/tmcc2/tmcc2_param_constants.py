...
class TMCC2RailSoundsDialogControl(TMCC2ParameterEnum):
    ...
    TOWER_STOP_HOLD = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_STOP_HOLD)
    TOWER_RESTRICTED_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_RESTRICTED_SPEED)
    TOWER_SLOW_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_SLOW_SPEED)
    TOWER_MEDIUM_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_MEDIUM_SPEED)
    TOWER_LIMITED_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_LIMITED_SPEED)
    TOWER_NORMAL_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_NORMAL_SPEED)
    TOWER_HIGHBALL_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_HIGHBALL_SPEED)
    ...
    ENGINEER_STOP_HOLD = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_STOP_SPEED_ACK)
    ENGINEER_RESTRICTED_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_RESTRICTED_SPEED_ACK)
    ENGINEER_SLOW_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_SLOW_SPEED_ACK)
    ENGINEER_MEDIUM_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_MEDIUM_SPEED_ACK)
    ENGINEER_LIMITED_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_LIMITED_SPEED_ACK)
    ENGINEER_NORMAL_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_NORMAL_SPEED_ACK)
    ENGINEER_HIGHBALL_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_HIGHBALL_SPEED_ACK)
