...
from src.protocol.command_def import CommandDefEnum, Mixins
...
class TMCC2RailSoundsDialogControl(TMCC2ParameterEnum):
    ...
    ENGINEER_DEPARTED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_HAVE_DEPARTED)
    ...
    ENGINEER_ARRIVING = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_ARRIVING_SOON)
    ENGINEER_ARRIVED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_HAVE_ARRIVED)
    ...
    ENGINEER_CONTEXT_DEPENDENT = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_CONTEXT_DEPENDENT)
    EMERGENCY_CONTEXT_DEPENDENT = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_EMERGENCY_CONTEXT_DEPENDENT)
    TOWER_CONTEXT_DEPENDENT = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_CONTEXT_DEPENDENT)
    TOWER_DEPARTURE_DENIED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_DEPARTURE_DENIED)
    TOWER_DEPARTURE_GRANTED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_DEPARTURE_GRANTED)
    TOWER_DEPARTED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_DEPARTED)
    TOWER_ALL_CLEAR = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_ALL_CLEAR)
    TOWER_ARRIVING = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_ARRIVING)
    TOWER_ARRIVED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_ARRIVED)
    TOWER_SHUTDOWN = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_TOWER_SHUT_DOWN)
    CONDUCTOR_ALL_ABOARD = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_CONDUCTOR_ALL_ABOARD)
    ENGINEER_ACK_STAND_BY = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_ACK_STANDING_BY)
    ENGINEER_ACK_CLEARED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_ACK_CLEARED_TO_GO)
    ENGINEER_ACK_CLEAR_AHEAD = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_ACK_CLEAR_AHEAD)
    ENGINEER_ACK_CLEAR_INBOUND = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_ACK_CLEAR_INBOUND)
    ENGINEER_ACK_WELCOME_BACK = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_ACK_WELCOME_BACK)
    ENGINEER_ACK_ID = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_ACK_ID)
    ENGINEER_FUEL_LEVEL = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_FUEL_LEVEL)
    ENGINEER_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_SPEED)
    ENGINEER_FUEL_REFILLED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_FUEL_REFILLED)
    ENGINEER_WATER_LEVEL = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_WATER_LEVEL)
    ENGINEER_WATER_REFILLED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_ENGINEER_WATER_REFILLED)
    SEQUENCE_OFF = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_SEQUENCE_CONTROL_OFF)
    SEQUENCE_ON = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_SEQUENCE_CONTROL_ON)
    SEQUENCE_CLEAR = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_SEQUENCE_CONTROL_CLEAR)
    SEQUENCE_DEPARTED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_SEQUENCE_CONTROL_DEPARTED)
    SEQUENCE_TRANSIT = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_SEQUENCE_CONTROL_TRANSIT)
    SEQUENCE_MAX_SPEED = TMCC2ParameterCommandDef(TMCC2_DIALOG_CONTROL_SEQUENCE_CONTROL_MAX_SPEED)
...
class TMCC2MaskingControl(TMCC2ParameterEnum):
    NC_NC = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_NC_SIGNAL_NC)
    ALWAYS_NC = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_PLAY_ALWAYS_SIGNAL_NC)
    NEVER_NC = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_PLAY_NEVER_SIGNAL_NC)
    DEFAULT_NC = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_DEFAULT_SIGNAL_NC)
    NC_ALWAYS = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_NC_SIGNAL_PLAY_ALWAYS)
    ALWAYS_ALWAYS = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_PLAY_ALWAYS_SIGNAL_PLAY_ALWAYS)
    NEVER_ALWAYS = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_PLAY_NEVER_SIGNAL_PLAY_ALWAYS)
    DEFAULT_ALWAYS = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_DEFAULT_SIGNAL_PLAY_ALWAYS)
    NC_NEVER = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_NC_SIGNAL_PLAY_NEVER)
    ALWAYS_NEVER = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_PLAY_ALWAYS_SIGNAL_PLAY_NEVER)
    NEVER_NEVER = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_PLAY_NEVER_SIGNAL_PLAY_NEVER)
    DEFAULT_NEVER = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_DEFAULT_SIGNAL_PLAY_NEVER)
    NC_DEFAULT = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_NC_SIGNAL_DEFAULT)
    PLAY_DEFAULT = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_PLAY_ALWAYS_SIGNAL_DEFAULT)
    NEVER_DEFAULT = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_PLAY_NEVER_SIGNAL_DEFAULT)
    DEFAULT_DEFAULT = TMCC2ParameterCommandDef(TMCC2_MASKING_DIALOG_DEFAULT_SIGNAL_DEFAULT)
    BRAKE_SQUEAL_ENABLE = TMCC2ParameterCommandDef(TMCC2_BRAKE_SQUEAL_ENABLE)
    BRAKE_SQUEAL_DISABLE = TMCC2ParameterCommandDef(TMCC2_BRAKE_SQUEAL_DISABLE)
