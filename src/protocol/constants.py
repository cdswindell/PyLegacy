...
class TMCC1EngineOption(EngineOption, Enum):
    ...
    FRONT_COUPLER = EngineOptionEnum(TMCC1_ENG_OPEN_FRONT_COUPLER_COMMAND)
    LET_OFF = EngineOptionEnum(TMCC1_ENG_LET_OFF_SOUND_COMMAND)
    MOMENTUM_HIGH = EngineOptionEnum(TMCC1_ENG_SET_MOMENTUM_HIGH_COMMAND)
    MOMENTUM_LOW = EngineOptionEnum(TMCC1_ENG_SET_MOMENTUM_LOW_COMMAND)
    MOMENTUM_MEDIUM = EngineOptionEnum(TMCC1_ENG_SET_MOMENTUM_MEDIUM_COMMAND)
    ...
    REAR_COUPLER = EngineOptionEnum(TMCC1_ENG_OPEN_REAR_COUPLER_COMMAND)
...
class TMCC2EngineOption(EngineOption, Enum):
    ...
    AUGER = EngineOptionEnum(TMCC2_ENG_AUGER_SOUND_COMMAND)
    BELL_OFF = EngineOptionEnum(TMCC2_BELL_OFF_COMMAND)
    BELL_ON = EngineOptionEnum(TMCC2_BELL_ON_COMMAND)
    BELL_ONE_SHOT_DING = EngineOptionEnum(TMCC2_BELL_ONE_SHOT_DING_COMMAND, d_max=3)
    BELL_SLIDER_POSITION = EngineOptionEnum(TMCC2_BELL_SLIDER_POSITION_COMMAND, d_min=2, d_max=5)
    ...
    BOOST_SPEED = EngineOptionEnum(TMCC2_BOOST_SPEED_COMMAND)
    BRAKE_AIR_RELEASE = EngineOptionEnum(TMCC2_ENG_BRAKE_AIR_RELEASE_SOUND_COMMAND)
    BRAKE_LEVEL = EngineOptionEnum(TMCC2_SET_BRAKE_COMMAND, d_max=7)
    BRAKE_SPEED = EngineOptionEnum(TMCC2_BRAKE_SPEED_COMMAND)
    BRAKE_SQUEAL = EngineOptionEnum(TMCC2_ENG_BRAKE_SQUEAL_SOUND_COMMAND)
    FORWARD_DIRECTION = EngineOptionEnum(TMCC2_FORWARD_DIRECTION_COMMAND)
    FRONT_COUPLER = EngineOptionEnum(TMCC2_OPEN_FRONT_COUPLER_COMMAND)
    LET_OFF = EngineOptionEnum(TMCC2_ENG_LET_OFF_SOUND_COMMAND)
    LET_OFF_LONG = EngineOptionEnum(TMCC2_ENG_LET_OFF_LONG_SOUND_COMMAND)
    MOMENTUM = EngineOptionEnum(TMCC2_SET_MOMENTUM_COMMAND, d_max=7)
    MOMENTUM_HIGH = EngineOptionEnum(TMCC2_SET_MOMENTUM_HIGH_COMMAND)
    MOMENTUM_LOW = EngineOptionEnum(TMCC2_SET_MOMENTUM_LOW_COMMAND)
    MOMENTUM_MEDIUM = EngineOptionEnum(TMCC2_SET_MOMENTUM_MEDIUM_COMMAND)
    NUMERIC = EngineOptionEnum(TMCC2_NUMERIC_COMMAND, d_max=10)
    QUILLING_HORN_INTENSITY = EngineOptionEnum(TMCC2_QUILLING_HORN_INTENSITY_COMMAND, d_max=16)
    REAR_COUPLER = EngineOptionEnum(TMCC2_OPEN_REAR_COUPLER_COMMAND)
    REFUELLING = EngineOptionEnum(TMCC2_ENG_REFUELLING_SOUND_COMMAND)
    ...
    START_UP_DELAYED = EngineOptionEnum(TMCC2_START_UP_SEQ_ONE_COMMAND)
    START_UP_IMMEDIATE = EngineOptionEnum(TMCC2_START_UP_SEQ_TWO_COMMAND)
    SHUTDOWN_DELAYED = EngineOptionEnum(TMCC2_SHUTDOWN_SEQ_ONE_COMMAND)
    SHUTDOWN_IMMEDIATE = EngineOptionEnum(TMCC2_SHUTDOWN_SEQ_TWO_COMMAND)
