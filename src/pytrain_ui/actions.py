...
CAB_ACTIONS: tuple[CabAction, ...] = (
    CabAction("startup", "Start Up", "START_UP_IMMEDIATE", "on_button.jpg", "e", hold=True, hold_command="START_UP_DELAYED"),
    CabAction("shutdown", "Shut Down", "SHUTDOWN_IMMEDIATE", "off_button.jpg", "e", hold=True, hold_command="SHUTDOWN_DELAYED"),
    ...
    CabAction("labor_down", "Labor −", "LABOR_EFFECT_DOWN", "effort-down.jpg", "e", command_kind="sequence", legacy_only=True),
    CabAction("labor_up", "Labor +", "LABOR_EFFECT_UP", "effort-up.jpg", "e", command_kind="sequence", legacy_only=True),
    CabAction("engineer_chatter", "Crew", "ENGINEER_CHATTER", "walkie_talkie.jpg", "e", hold=True, hold_kind="panel", hold_target="crew"),
    CabAction("tower_chatter", "Tower", "TOWER_CHATTER", "tower.jpg", "e", hold=True, hold_kind="panel", hold_target="tower"),
    ...
    CabAction("conductor", "Conductor", "ENGINEER_CHATTER", "conductor.jpg", "p", hold=True, hold_kind="panel", hold_target="conductor"),
    CabAction("station", "Station", "TOWER_CHATTER", "station.jpg", "p", hold=True, hold_kind="panel", hold_target="station"),
    CabAction("steward", "Steward", "STEWARD_CHATTER", "steward.jpg", "p", command_kind="generic", hold=True, hold_kind="panel", hold_target="steward"),

    CabAction("pantograph_front_down", "Front Panto Down", "PANTO_FRONT_DOWN_CAB2", "panto-down-f.jpg", "l", command_kind="effects", legacy_only=True),
    CabAction("pantograph_front_up", "Front Panto Up", "PANTO_FRONT_UP_CAB2", "panto-up-f.jpg", "l", command_kind="effects", legacy_only=True),
    CabAction("pantograph_rear_down", "Rear Panto Down", "PANTO_REAR_DOWN_CAB2", "panto-down-r.jpg", "l", command_kind="effects", legacy_only=True),
    CabAction("pantograph_rear_up", "Rear Panto Up", "PANTO_REAR_UP_CAB2", "panto-up-r.jpg", "l", command_kind="effects", legacy_only=True),
    ...
    CabAction("pantograph_both_down", "Pantographs Down", "PANTO_BOTH_DOWN", "panto-down-a.jpg", "a", command_kind="effects", legacy_only=True),
    CabAction("pantograph_both_up", "Pantographs Up", "PANTO_BOTH_UP", "panto-up-a.jpg", "a", command_kind="effects", legacy_only=True),

    CabAction("sequence", "Aux1 · Sequence", "AUX1_OPTION_ONE", scope_tag="e", group="secondary", repeat=True),
    CabAction("lights", "Aux2 · Lights", "AUX2_OPTION_ONE", scope_tag="e", group="secondary", hold=True, hold_kind="panel", hold_target="lights"),
    CabAction("more", "Aux3 · More", "AUX3_OPTION_ONE", scope_tag="e", group="secondary", hold=True, hold_kind="panel", hold_target="more"),
