...
CAB_ACTIONS: tuple[CabAction, ...] = (
    CabAction(
        "startup", "Start Up", "START_UP_IMMEDIATE", "on_button.jpg", "e",
        hold=True, hold_command="START_UP_DELAYED",
    ),
    CabAction(
        "shutdown", "Shut Down", "SHUTDOWN_IMMEDIATE", "off_button.jpg", "e",
        hold=True, hold_command="SHUTDOWN_DELAYED",
    ),
    ...
    CabAction(
        "tower_chatter", "Tower", "TOWER_CHATTER", "tower.jpg", "e",
        hold=True, hold_kind="panel", hold_target="tower",
    ),
    CabAction(
    ...
    CabAction(
        "electric_smoke_down", "Smoke −", "SMOKE_OFF", "smoke-down.jpg", "l", command_kind="smoke",
    ),
    CabAction(
        "electric_smoke_up", "Smoke +", "SMOKE_ON", "smoke-up.jpg", "l", command_kind="smoke",
    ),
    CabAction(
    ...
    CabAction(
        "sequence", "Aux1 · Sequence", "AUX1_OPTION_ONE", scope_tag="e", group="secondary", repeat=True,
    ),
    CabAction(
