        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Column {
                    ...
                    Label {
                        ...
                        text: "SPEED"
                        color: "#9ea6b0"
                        font.pixelSize: root.piLayout ? 10 : 12
                    }
                    Label {
                        anchors.horizontalCenter: parent.horizontalCenter
                        text: cab.speed
                        color: "white"
                        font.pixelSize: root.piLayout ? 22 : 28
                        font.bold: true
                    }
                }
            }
            Rectangle {
                ...
                Column {
                    ...
                    Label {
                        anchors.horizontalCenter: parent.horizontalCenter
                        text: throttle.dragging ? throttle.pendingValue : cab.targetSpeed
                        color: "white"
                        font.pixelSize: root.piLayout ? 22 : 28
                        font.bold: true
                    }
        ...
        RowLayout {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    Label {
                        ...
                        horizontalAlignment: Text.AlignHCenter
                        verticalAlignment: Text.AlignVCenter
                        font.pixelSize: root.piLayout ? 10 : 14
                    }
                    VerticalThrottle {
                        id: throttle
                        Layout.fillHeight: true
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    CabButton {
                        Layout.fillWidth: true
                        Layout.preferredHeight: root.piLayout ? 50 : 56
                        text: "HALT"
                        font.pixelSize: root.piLayout ? 18 : 20
                        font.bold: true
                        normalColor: "#9d2020"
                        pressedColor: "#c62d2d"
                        onClicked: cab.stop()
                    ...
                    CabButton {
                        Layout.preferredWidth: root.piLayout ? 94 : 112
                        Layout.preferredHeight: root.piLayout ? 50 : 56
                        text: "Reset"
                        font.pixelSize: root.piLayout ? 14 : 15
                        onClicked: cab.reset()
                    }
                }
            }
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Label {
                            ...
                            text: modelData.label
                            color: "#8f98a4"
                            font.pixelSize: root.piLayout ? 8 : 10
                        }
                        Label {
                            anchors.horizontalCenter: parent.horizontalCenter
                            text: modelData.value
                            color: "#e7eaee"
                            font.pixelSize: root.piLayout ? 11 : 13
                            font.bold: true
                        }
                    }
                }
    ...
    Popup {
        ...
        ColumnLayout {
            ...
            Slider {
                ...
                stepSize: 1
                value: cab.speedLimit
            }
            Label {
                Layout.fillWidth: true
                text: Math.round(speedLimitSlider.value)
                color: "#dce3eb"
                horizontalAlignment: Text.AlignHCenter
                font.pixelSize: 18
            }
            RowLayout {
                ...
                CabButton {
                    ...
                    normalColor: "#246aa0"
                    onClicked: {
                        cab.setSpeedLimit(Math.round(speedLimitSlider.value))
                        speedLimitPopup.close()
                    }
                }
            }
