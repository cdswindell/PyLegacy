    ...
    RowLayout {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                radius: 7
                color: root.currentScope === modelData ? "#246aa0" : "#303640"
                ...
                Label {
                    ...
                    text: modelData === "ACCESSORY" ? "Accessory" : modelData.charAt(0) + modelData.slice(1).toLowerCase()
                    color: "#f4f6f8"
                    horizontalAlignment: Text.AlignHCenter
                    elide: Text.ElideRight
                    font.pixelSize: 12
                    font.bold: root.currentScope === modelData
                }
            }
        }
    }
