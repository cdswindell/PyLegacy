        ...
        with self._lock:
            ...
            for i in interrupts:
                ...
                if i in self._clients:
                    ...
                    # but we need to make sure each button has settled before we
                    # decide if its state has changed
                    ...
                    # this is part of debouncing; the current button state must match
