...
class PyTrain:
    ...
    def get_service_info(self) -> Tuple[str, int] | None:
        ...
        """
        # use poling to see if network is up/loaded at the OS level
        ...
        if ui:
            ...
            if ui_parts[0]:
                ...
                try:
                    ...
                    ui_parser.remove_args(["base", "baudrate", "client", "port", "server"])
                    ...
                    if scope in self._state_store:
                        ...
                        for state in self._state_store.get_all(scope):
                            if (
                                ...
                                or (isinstance(state, EngineState) and state.bt_id and query == state.bt_id.lower())
                            ):
                                print(state)
                                no_data = False
                        if no_data:
