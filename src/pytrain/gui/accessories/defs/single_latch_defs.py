...
"""
Single Latch definition (GUI-agnostic).
...
_VARIANTS: dict[str, str] = {
    ...
    "k line operating freight platform 6-21449.jpg": "K-Line-Operating-Freight-Platform-6-21449.jpg",
}

# filename -> display/title
_TITLES: dict[str, str] = {
    "Hobo-Depot-6-34191.jpg": "Hobo Depot",
    "K-Line-Operating-Freight-Platform-6-21449.jpg": "Freight Platform",
}

# optional extra aliases keyed by legacy key (same pattern as milk loader)
ALIASES: dict[str, set[str]] = {
    "hobo depot 6-34191": {"depot"},
    "k line operating freight platform 6-21449.jpg": {"platform", "freight platform", "operating freight platform"},
}
...
def register_single_latch(registry: AccessoryRegistry) -> None:
    """
    Register Single Latch accessory type metadata.
    """
    operations = (
        OperationSpec(
            key="power",
    ...
    spec = AccessoryTypeSpec(
        type=AccessoryType.SINGLE_LATCH,
        display_name="Single Latch",
...
if __name__ == "__main__":  # pragma: no cover
    ...
    register_single_latch(reg)
    print_registry_entry("single_latch")
