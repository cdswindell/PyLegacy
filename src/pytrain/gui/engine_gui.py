...
class EngineGui(Thread, Generic[S]):
    ...
    def make_controller(self, app):
        ...
        throttle.tk.bind("<ButtonRelease-1>", lambda e: throttle.tk.after(100, lambda: app.tk.focus(None)))
        throttle.tk.bind("<ButtonRelease>", lambda e: throttle.tk.after(100, lambda: app.tk.focus(None)))
