...
button = PushButton(center_box, image=launch_jpg, height=128, width=128, grid=[0, 0, 1, 2], padx=0, pady=0)
...
abort = PushButton(center_box, image=abort_jpg, height=128, width=128, grid=[4, 0, 1, 2], padx=0, pady=0)
