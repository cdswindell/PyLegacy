...
TMCC1_ACC_TOGGLE_DIRECTION_COMMAND: int = 0x8001
...
class TMCC1AuxCommandEnum(TMCC1Enum):
    ...
    TOGGLE_DIRECTION = TMCC1CommandDef(TMCC1_ACC_TOGGLE_DIRECTION_COMMAND, TMCC1CommandIdentifier.ACC)
    ...
    # FORWARD_SPEED = TMCC1CommandDef(
    #     TMCC1_ACC_FORWARD_SPEED_COMMAND, TMCC1CommandIdentifier.ACC, d_map=FORWARD_SPEED_MAP
    # )
...
class TMCC1EngineCommandEnum(TMCC1Enum):
    ...
    ENGINEER_CHATTER = TMCC1CommandDef(TMCC1_ENG_NUMERIC_COMMAND | 2, alias="NUMERIC", data=2)
    ...
    FUNC_MINUS = TMCC1CommandDef(TMCC1_ENG_FUNC_MINUS_COMMAND | 8, alias="NUMERIC", data=8)
    FUNC_PLUS = TMCC1CommandDef(TMCC1_ENG_FUNC_PLUS_COMMAND | 9, alias="NUMERIC", data=9)
    ...
    RESET = TMCC1CommandDef(TMCC1_ENG_NUMERIC_COMMAND | 0, alias="NUMERIC", data=0, interval=100)
