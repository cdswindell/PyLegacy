...
class TMCC2EffectsControl(TMCC2ParameterEnum):
    PANTO_FRONT_DOWN_CAB2 = MultiByteCommandDef(TMCC2_EFFECTS_CONTROL_PANTOGRAPH_FRONT_DOWN_CAB2)
    PANTO_FRONT_UP_CAB2 = MultiByteCommandDef(TMCC2_EFFECTS_CONTROL_PANTOGRAPH_FRONT_UP_CAB2)
    PANTO_REAR_DOWN_CAB2 = MultiByteCommandDef(TMCC2_EFFECTS_CONTROL_PANTOGRAPH_REAR_DOWN_CAB2)
    PANTO_REAR_UP_CAB2 = MultiByteCommandDef(TMCC2_EFFECTS_CONTROL_PANTOGRAPH_REAR_UP_CAB2)
    ...
    STOCK_SCENE_ZERO = MultiByteCommandDef(TMCC2_EFFECTS_CONTROL_SCENE_ZERO)
    STOCK_SCENE_ONE = MultiByteCommandDef(TMCC2_EFFECTS_CONTROL_SCENE_ONE)
    STOCK_SCENE_TWO = MultiByteCommandDef(TMCC2_EFFECTS_CONTROL_SCENE_TWO)
    STOCK_SCENE_THREE = MultiByteCommandDef(TMCC2_EFFECTS_CONTROL_SCENE_THREE)
    ...
    STOCK_OPTION_TWO_OFF = MultiByteCommandDef(TMCC2_EFFECTS_CONTROL_STOCK_CAR_OPTION_TWO_OFF)
...
class TMCC2LightingControl(TMCC2ParameterEnum):
    ...
    CAR_TOGGLE = MultiByteCommandDef(TMCC2_LIGHTING_CONTROL_CAR_LIGHT_TOGGLE)
