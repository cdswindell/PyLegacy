...
class TMCC2EngineCommandEnum(TMCC2Enum, TMCC2EngineOpsEnum):
    ...
    AUX1_OPTION_ONE = TMCC2CommandDef(TMCC2_AUX1_OPTION_ONE_COMMAND, interval=100)
    ...
    ENGINEER_CHATTER = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 2, alias="NUMERIC", data=2)
    ...
    NUMERIC = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND, d_max=9, interval=100)
    ...
    RESET = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 0, alias="NUMERIC", data=0, interval=100)
    ...
    EMERGENCY_STOP = TMCC2CommandDef(TMCC2_SET_ABSOLUTE_SPEED_COMMAND, alias="ABSOLUTE_SPEED", data=0)
    ...
    POWERMASTER_OFF = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 0, alias="NUMERIC", data=0)
    NUMBER_1 = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 1, alias="NUMERIC", data=1)
    NUMBER_2 = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 2, alias="NUMERIC", data=2)
    NUMBER_3 = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 3, alias="NUMERIC", data=3)
    NUMBER_4 = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 4, alias="NUMERIC", data=4)
    NUMBER_5 = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 5, alias="NUMERIC", data=5)
    NUMBER_6 = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 6, alias="NUMERIC", data=6)
    NUMBER_7 = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 7, alias="NUMERIC", data=7)
    ...
    NUMBER_0 = TMCC2CommandDef(TMCC2_NUMERIC_COMMAND | 0, alias="NUMERIC", data=0, interval=100)
