...
class CommandReq:
    ...
    def build(
        ...
        from src.pytrain.protocol.multybyte.multibyte_constants import TMCC2MultiByteEnum
        ...
        if isinstance(command, SequenceCommandEnum):
            ...
            from src.pytrain.protocol.multybyte.param_command_req import MultiByteReq
    ...
    def build_tmcc2_command_req(cls, param: bytes, is_tmcc4: bool = False) -> R:
        if len(param) == 3 or (is_tmcc4 is True and len(param) == 7):
            ...
            from src.pytrain.protocol.multybyte.multibyte_command_req import MultiByteReq
