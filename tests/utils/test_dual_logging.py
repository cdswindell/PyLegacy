...
# tests/utils/test_dual_logging.py
import io
import logging
...
def _reset_root_logger():
    ...
    # close and remove handlers to avoid cross-tests interference and file locks
...
def clean_logging():
    # ensure a clean logger before and after each tests
    _reset_root_logger()
    yield
    _reset_root_logger()
