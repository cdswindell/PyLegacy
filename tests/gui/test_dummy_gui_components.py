...
def test_toggle_power_on_path(monkeypatch):
    ...
    def mini_run(self):
        ...
        self.power_button = DummyPushButton(image=self.on_button, height=self.s_acc, width=self.s_acc)
        self.lights_button = DummyPushButton(image=self.on_button, height=self.s_acc, width=self.s_acc)
...
def test_toggle_power_off_path(monkeypatch):
    def mini_run(self):
        ...
        self.gantry_box = DummyBox()
        self.comms_box = None
        self.power_button = DummyPushButton(image=self.off_button, height=self.s_acc, width=self.s_acc)
        self.lights_button = DummyPushButton(image=self.on_button, height=self.s_acc, width=self.s_acc)
        self.klaxon_button = DummyPushButton(image=self.siren_on, height=self.s_acc, width=self.s_acc)
        self.label = DummyText(text="T-Minus")
        self.message = DummyText(text="")
        self.count = DummyText(text="")
        self.launch = DummyPushButton()
...
def test_set_lights_icons_and_klaxon_off(monkeypatch):
    ...
    assert inst.lights_button.height == inst.s_acc
    assert inst.lights_button.width == inst.s_acc
    ...
    assert inst.klaxon_button.height == inst.s_acc
    assert inst.klaxon_button.width == inst.s_acc
